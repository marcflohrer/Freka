...
public class TestQueueHandlerGenerator : StaticSourceCodeGenBase, IStaticSourceCodeGen
{
    public TestQueueHandlerGenerator(DirectoryInfo sourceDirectory)
        : base(sourceDirectory, "TestQueueHandler") { }
