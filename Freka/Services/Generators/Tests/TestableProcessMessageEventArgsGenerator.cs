...
public class TestableProcessMessageEventArgsGenerator : StaticSourceCodeGenBase, IStaticSourceCodeGen
{
    public TestableProcessMessageEventArgsGenerator(DirectoryInfo sourceDirectory)
        : base(sourceDirectory, "TestableProcessMessageEventArgs") { }
